...
본 저장소에는 대회 시연에 사용한 주요 Python 코드, Arduino 펌웨어, 실행 스크립트 및 학습된 SVM 모델이 포함되어 있습니다.

학습 원본 데이터와 실제 사용자 프로필·운전 로그는 개인정보 보호를 위해 공개하지 않습니다. 공개된 모델 파일은 본 프로젝트의 실행 및 구조 확인을 위한 목적으로 제공됩니다.

---

## 12. 안내

본 작품은 2026 임베디드소프트웨어 경진대회를 위해 제작된 프로토타입입니다. 자세 분석 및 경고 결과는 운전자 자세 관리 지원을 위한 것이며, 의료 진단이나 양산 차량용 안전장치를 목적으로 하지 않습니다.
