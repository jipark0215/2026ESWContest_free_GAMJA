...
| **장예은** | AI / Sensor / Circuit Fabrication / Data Processing | - CNN 기반 사용자·자세 분류 모델을 구축 및 SVM 모델과 성능 비교·검증 <br>- FSR 센서 민감도 및 특성에 따른 회로 설계·실제 시트 내 기판 회로 제작<br>- Arduino Mega 기반 16채널 FSR 압력센서 데이터 통신 구조 구현<br>- 압력 센서 데이터 수집·통합·유사 데이터 제거·이상치 검토 과정 자동화 파이프라 구축<br>- 초기 가상 데이터 구축 및 재학습용 데이터셋 구축<br>- 실제 데이터셋을 통 자세 분류 모델 재학습·테스트를 통한 성능 검증 |
